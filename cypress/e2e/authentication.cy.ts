describe("Authentication tests", () => {
  ...
  it("Successfully login, open settings modal and delete account", () => {
    cy.visit("/login");
    ...
    cy.get('[data-testid="delete-account-modal-button"]').click();

    cy.get('[data-testid="delete-account-confirm-button"]').click();
